        ...
        <div>
            ...
            <form className='flex flex-col w-[55%]'>
            {
              !isLogin && (
                ...
                <input type='email' placeholder='Email' className='outline-blue-500 border border-gray-800 px-3 py-1 rounded-full my-1 font-semibold' />
                <input type='password' placeholder='Password' className='outline-blue-500 border border-gray-800 px-3 py-1 rounded-full my-1 font-semibold' />
                
                
                <button className='border-none py-2 my-4 rounded-full text-lg text-white bg-[#1DA1F2]' onClick={loginHandler}>{isLogin?"Login":"Create Account"} </button>
